const styles = {
	...
	heroSubText:
		' font-black lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]',
	heroSemiText:
		' font-black lg:text-[20px] sm:text-[20px] xs:text-[16px] text-[12px] lg:leading-[28px]',
