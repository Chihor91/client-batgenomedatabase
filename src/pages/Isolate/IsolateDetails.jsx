                  ...
                  <DetailSection
                    ...
                    rows={[
                      ...
                      data.morphology?.motility !== undefined && {
                        label: "Motility",
                        value: data.morphology.motility ? "Yes" : "No",
                      },
                    ].filter(Boolean)}
                  />
                )}
                  ...
                  <DetailSection
                    ...
                    rows={[
                      data.physiology_metabolism?.oxygen_tolerance && {
                        ...
                        value: data.physiology_metabolism.oxygen_tolerance,
                      },
                      data.physiology_metabolism?.cytochrome_oxidase !==
                        undefined && {
                        label: "Presence of Cytochrome c Oxidase",
                        value: data.physiology_metabolism.cytochrome_oxidase
                          ? "Oxidase-positive"
                          : "Oxidase-negative",
                      },
                      data.physiology_metabolism?.endospore_forming !==
                        undefined && {
                        label: "Endospore-forming Capability",
                        value: data.physiology_metabolism.endospore_forming
                          ? "Endospore-forming"
                ...
                {!jsonEmpty(data.safety_information) && (
                  <DetailSection
                    ...
                    rows={[
                      ...
                      data.safety_information?.pathogenicity_animal !==
                        undefined && {
                      ...
                      data.safety_information?.biosafety_level && {
                        ...
                        value: data.safety_information.biosafety_level,
                      },
                    ].filter(Boolean)}
                  />
                )}
