        ...
        <div className="mx-20 mr-10 flex flex-col space-y-10 md:flex-row md:space-y-0 lg:mx-0">
          <div className="max-w-full md:max-w-[50%]">
            <span className="lg:mx-[50px] text-justify inline-block">
              The <span className="font-semibold">IMCavesPH</span> database is a
              culture collection information system developed by the{" "}
              <span className="font-semibold">
                UPLB Museum of Natural History (UPLB-MNH)
              </span>{" "}
              for storage of microbiological and demographic information of cave
              microorganisms sampled from various caves in the Philippines under
              the&nbsp;
              <a
          ...
          <Separator
            ...
            className="hidden md:block mx-10 h-auto"
          />
